...
const env = helpers.requireEnviroments('prod') || {};
 ...
 */
 ...
 const LANGUAGES = APP_CONFIG.webtranslateit && APP_CONFIG.webtranslateit.langs ? APP_CONFIG.webtranslateit.langs : ['ES'];
...
module.exports = function (env) {
  ...
  env.native = env.native === 'true';

  _.each(LANGUAGES, function (lang) {
    builds.push(webpackMerge.smart(
      commonConfig({env: ENV}),
      {
        entry: {
          'main': env.native ? './src/native/main.ts' : './src/web/main.ts'
        },
        /**
...
/*          new ngtools.AotPlugin({
            ...
            //baseDir: helpers.root(),
            entryModule: helpers.root('src/app/app.module')
          }),*/
